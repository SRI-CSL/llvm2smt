...
;; BLOCK %3 with index 1 and rank = 2
;; Predecessors: %7 %0
;; Backward pointers: %7
...
(define-fun |%4_@exp0| () (_ BitVec 16) (read16 memory5 |%2_@exp0|))
;; %5 = zext i16 %4 to i32
(define-fun |%5_@exp0| () (_ BitVec 32) ((_ zero_extend 16) |%4_@exp0|))
;; %6 = icmp sgt i32 %5, 0
(define-fun |%6_@exp0| () Bool (bvsgt |%5_@exp0| (_ bv0 32)))
;; br i1 %6, label %7, label %18
;; No backward arrows

;; BLOCK %7 with index 2 and rank = 3
;; Predecessors: %3
;; @exp0_block_2_entry_condition 
(define-fun @exp0_block_2_entry_condition () Bool
    (and @exp0_block_1_entry_condition |%6_@exp0|)
)
;;Memory PHI
(define-fun memory6 () Mem memory5)
;; %8 = load i16* %1, align 2
(define-fun |%8_@exp0| () (_ BitVec 16) (read16 memory6 |%1_@exp0|))
;; %9 = zext i16 %8 to i32
(define-fun |%9_@exp0| () (_ BitVec 32) ((_ zero_extend 16) |%8_@exp0|))
;; %10 = load i16* %retval, align 2
(define-fun |%10_@exp0| () (_ BitVec 16) (read16 memory6 |%retval_@exp0|))
;; %11 = zext i16 %10 to i32
(define-fun |%11_@exp0| () (_ BitVec 32) ((_ zero_extend 16) |%10_@exp0|))
;; %12 = mul nsw i32 %11, %9
(define-fun |%12_@exp0| () (_ BitVec 32) (bvmul |%11_@exp0| |%9_@exp0|))
;; %13 = trunc i32 %12 to i16
(define-fun |%13_@exp0| () (_ BitVec 16) ((_ extract 15 0) |%12_@exp0|))
;; store i16 %13, i16* %retval, align 2
(define-fun memory7 () Mem (write16 memory6 |%retval_@exp0| |%13_@exp0|))
;; %14 = load i16* %2, align 2
(define-fun |%14_@exp0| () (_ BitVec 16) (read16 memory7 |%2_@exp0|))
;; %15 = zext i16 %14 to i32
(define-fun |%15_@exp0| () (_ BitVec 32) ((_ zero_extend 16) |%14_@exp0|))
;; %16 = sub nsw i32 %15, 1
(define-fun |%16_@exp0| () (_ BitVec 32) (bvsub |%15_@exp0| (_ bv1 32)))
;; %17 = trunc i32 %16 to i16
(define-fun |%17_@exp0| () (_ BitVec 16) ((_ extract 15 0) |%16_@exp0|))
;; store i16 %17, i16* %2, align 2
(define-fun memory8 () Mem (write16 memory7 |%2_@exp0| |%17_@exp0|))
;; br label %3
;; BACKWARD ARROWS:  %3
(assert 
    (not @exp0_block_2_entry_condition)
)

;; BLOCK %18 with index 3 and rank = 3
;; Predecessors: %3
;; @exp0_block_3_entry_condition 
(define-fun @exp0_block_3_entry_condition () Bool
    (and @exp0_block_1_entry_condition (not |%6_@exp0|))
)
;;Memory PHI
(define-fun memory9 () Mem memory5)
;; %19 = load i16* %retval, align 2
(define-fun |%19_@exp0| () (_ BitVec 16) (read16 memory9 |%retval_@exp0|))
;; ret i16 %19
;; No backward arrows


(define-fun @exp0_result () (_ BitVec 16) |%19_@exp0|)

;; Function: |@exp1|
;; (i16 zeroext %a, i16 zeroext %b)
(declare-fun memory10 () Mem)
...
;; store i16 %a, i16* %1, align 2
(define-fun memory11 () Mem (write16 memory10 |%1_@exp1| |%a_@exp1|))
;; store i16 %b, i16* %2, align 2
(define-fun memory12 () Mem (write16 memory11 |%2_@exp1| |%b_@exp1|))
;; store i16 1, i16* %retval, align 2
(define-fun memory13 () Mem (write16 memory12 |%retval_@exp1| (_ bv1 16)))
;; br label %3
;; No backward arrows
...
;;Memory PHI
(define-fun memory14 () Mem memory13)
;; %4 = load i16* %2, align 2
(define-fun |%4_@exp1| () (_ BitVec 16) (read16 memory14 |%2_@exp1|))
;; %5 = zext i16 %4 to i32
(define-fun |%5_@exp1| () (_ BitVec 32) ((_ zero_extend 16) |%4_@exp1|))
;; %6 = icmp ne i32 %5, 0
(define-fun |%6_@exp1| () Bool (distinct |%5_@exp1| (_ bv0 32)))
...
(define-fun @exp1_block_2_entry_condition () Bool
    (and @exp1_block_1_entry_condition |%6_@exp1|)
)
;;Memory PHI
(define-fun memory15 () Mem memory14)
;; %8 = load i16* %2, align 2
(define-fun |%8_@exp1| () (_ BitVec 16) (read16 memory15 |%2_@exp1|))
;; %9 = zext i16 %8 to i32
(define-fun |%9_@exp1| () (_ BitVec 32) ((_ zero_extend 16) |%8_@exp1|))
;; %10 = and i32 %9, 1
(define-fun |%10_@exp1| () (_ BitVec 32) (bvand |%9_@exp1| (_ bv1 32)))
;; %11 = icmp ne i32 %10, 0
(define-fun |%11_@exp1| () Bool (distinct |%10_@exp1| (_ bv0 32)))
;; br i1 %11, label %12, label %19
;; No backward arrows

;; BLOCK %30 with index 5 and rank = 3
;; Predecessors: %3
;; @exp1_block_5_entry_condition 
(define-fun @exp1_block_5_entry_condition () Bool
    (and @exp1_block_1_entry_condition (not |%6_@exp1|))
)
;;Memory PHI
(define-fun memory16 () Mem memory14)
;; %31 = load i16* %retval, align 2
(define-fun |%31_@exp1| () (_ BitVec 16) (read16 memory16 |%retval_@exp1|))
;; ret i16 %31
;; No backward arrows

;; BLOCK %12 with index 3 and rank = 4
;; Predecessors: %7
;; @exp1_block_3_entry_condition 
(define-fun @exp1_block_3_entry_condition () Bool
    (and @exp1_block_2_entry_condition |%11_@exp1|)
)
;;Memory PHI
(define-fun memory17 () Mem memory15)
;; %13 = load i16* %1, align 2
(define-fun |%13_@exp1| () (_ BitVec 16) (read16 memory17 |%1_@exp1|))
;; %14 = zext i16 %13 to i32
(define-fun |%14_@exp1| () (_ BitVec 32) ((_ zero_extend 16) |%13_@exp1|))
;; %15 = load i16* %retval, align 2
(define-fun |%15_@exp1| () (_ BitVec 16) (read16 memory17 |%retval_@exp1|))
;; %16 = zext i16 %15 to i32
(define-fun |%16_@exp1| () (_ BitVec 32) ((_ zero_extend 16) |%15_@exp1|))
;; %17 = mul nsw i32 %16, %14
(define-fun |%17_@exp1| () (_ BitVec 32) (bvmul |%16_@exp1| |%14_@exp1|))
;; %18 = trunc i32 %17 to i16
(define-fun |%18_@exp1| () (_ BitVec 16) ((_ extract 15 0) |%17_@exp1|))
;; store i16 %18, i16* %retval, align 2
(define-fun memory18 () Mem (write16 memory17 |%retval_@exp1| |%18_@exp1|))
;; br label %19
;; No backward arrows

;; BLOCK %19 with index 4 and rank = 5
;; Predecessors: %12 %7
;; @exp1_block_4_entry_condition 
(define-fun @exp1_block_4_entry_condition () Bool
    (or
        @exp1_block_3_entry_condition
        (and @exp1_block_2_entry_condition (not |%11_@exp1|))
    )
)
;;Memory PHI
(define-fun memory19 () Mem 
    (ite @exp1_block_3_entry_condition memory18 memory15
    ))
;; %20 = load i16* %2, align 2
(define-fun |%20_@exp1| () (_ BitVec 16) (read16 memory19 |%2_@exp1|))
;; %21 = zext i16 %20 to i32
(define-fun |%21_@exp1| () (_ BitVec 32) ((_ zero_extend 16) |%20_@exp1|))
;; %22 = ashr i32 %21, 1
(define-fun |%22_@exp1| () (_ BitVec 32) (bvashr |%21_@exp1| (_ bv1 32)))
;; %23 = trunc i32 %22 to i16
(define-fun |%23_@exp1| () (_ BitVec 16) ((_ extract 15 0) |%22_@exp1|))
;; store i16 %23, i16* %2, align 2
(define-fun memory20 () Mem (write16 memory19 |%2_@exp1| |%23_@exp1|))
;; %24 = load i16* %1, align 2
(define-fun |%24_@exp1| () (_ BitVec 16) (read16 memory20 |%1_@exp1|))
;; %25 = zext i16 %24 to i32
(define-fun |%25_@exp1| () (_ BitVec 32) ((_ zero_extend 16) |%24_@exp1|))
;; %26 = load i16* %1, align 2
(define-fun |%26_@exp1| () (_ BitVec 16) (read16 memory20 |%1_@exp1|))
;; %27 = zext i16 %26 to i32
(define-fun |%27_@exp1| () (_ BitVec 32) ((_ zero_extend 16) |%26_@exp1|))
;; %28 = mul nsw i32 %27, %25
(define-fun |%28_@exp1| () (_ BitVec 32) (bvmul |%27_@exp1| |%25_@exp1|))
;; %29 = trunc i32 %28 to i16
(define-fun |%29_@exp1| () (_ BitVec 16) ((_ extract 15 0) |%28_@exp1|))
;; store i16 %29, i16* %1, align 2
(define-fun memory21 () Mem (write16 memory20 |%1_@exp1| |%29_@exp1|))
;; br label %3
;; BACKWARD ARROWS:  %3
(assert 
    (not @exp1_block_4_entry_condition)
)


(define-fun @exp1_result () (_ BitVec 16) |%31_@exp1|)
...
;; store i32 0, i32* %1
(define-fun memory23 () Mem (write32 memory22 |%1_@main| (_ bv0 32)))
;; store i32 %argc, i32* %2, align 4
(define-fun memory24 () Mem (write32 memory23 |%2_@main| |%argc_@main|))
;; store i8** %argv, i8*** %3, align 8
(define-fun memory25 () Mem (write64 memory24 |%3_@main| |%argv_@main|))
;; ret i32 0
;; No backward arrows
