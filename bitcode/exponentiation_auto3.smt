...
(define-fun |%8_@exp0| () (_ BitVec 32) (read32 memory5 |%3_@exp0|))
;; %9 = icmp sgt i32 %8, 0
...
(define-fun |%11_@exp0| () (_ BitVec 32) (read32 memory5 |%2_@exp0|))
;; %12 = load i32* %retval, align 4
(define-fun |%12_@exp0| () (_ BitVec 32) (read32 memory5 |%retval_@exp0|))
;; %13 = mul nsw i32 %12, %11
(define-fun |%13_@exp0| () (_ BitVec 32) (bvmul |%12_@exp0| |%11_@exp0|))
;; store i32 %13, i32* %retval, align 4
(define-fun memory6 () Mem (write32 memory5 |%retval_@exp0| |%13_@exp0|))
;; %14 = load i32* %3, align 4
(define-fun |%14_@exp0| () (_ BitVec 32) (read32 memory6 |%3_@exp0|))
;; %15 = sub nsw i32 %14, 1
(define-fun |%15_@exp0| () (_ BitVec 32) (bvsub |%14_@exp0| (_ bv1 32)))
;; store i32 %15, i32* %3, align 4
(define-fun memory7 () Mem (write32 memory6 |%3_@exp0| |%15_@exp0|))
;; %16 = load i32* %3, align 4
(define-fun |%16_@exp0| () (_ BitVec 32) (read32 memory7 |%3_@exp0|))
...
(define-fun |%23_@exp0| () (_ BitVec 32) (read32 memory7 |%2_@exp0|))
;; %24 = load i32* %retval, align 4
(define-fun |%24_@exp0| () (_ BitVec 32) (read32 memory7 |%retval_@exp0|))
;; %25 = mul nsw i32 %24, %23
(define-fun |%25_@exp0| () (_ BitVec 32) (bvmul |%24_@exp0| |%23_@exp0|))
;; store i32 %25, i32* %retval, align 4
(define-fun memory8 () Mem (write32 memory7 |%retval_@exp0| |%25_@exp0|))
;; %26 = load i32* %3, align 4
(define-fun |%26_@exp0| () (_ BitVec 32) (read32 memory8 |%3_@exp0|))
;; %27 = sub nsw i32 %26, 1
(define-fun |%27_@exp0| () (_ BitVec 32) (bvsub |%26_@exp0| (_ bv1 32)))
;; store i32 %27, i32* %3, align 4
(define-fun memory9 () Mem (write32 memory8 |%3_@exp0| |%27_@exp0|))
;; %28 = load i32* %3, align 4
(define-fun |%28_@exp0| () (_ BitVec 32) (read32 memory9 |%3_@exp0|))
...
(define-fun |%31_@exp0| () (_ BitVec 32) (read32 memory9 |%2_@exp0|))
;; %32 = load i32* %retval, align 4
(define-fun |%32_@exp0| () (_ BitVec 32) (read32 memory9 |%retval_@exp0|))
;; %33 = mul nsw i32 %32, %31
(define-fun |%33_@exp0| () (_ BitVec 32) (bvmul |%32_@exp0| |%31_@exp0|))
;; store i32 %33, i32* %retval, align 4
(define-fun memory10 () Mem (write32 memory9 |%retval_@exp0| |%33_@exp0|))
;; %34 = load i32* %3, align 4
(define-fun |%34_@exp0| () (_ BitVec 32) (read32 memory10 |%3_@exp0|))
;; %35 = sub nsw i32 %34, 1
(define-fun |%35_@exp0| () (_ BitVec 32) (bvsub |%34_@exp0| (_ bv1 32)))
;; store i32 %35, i32* %3, align 4
(define-fun memory11 () Mem (write32 memory10 |%3_@exp0| |%35_@exp0|))
;; %36 = load i32* %3, align 4
(define-fun |%36_@exp0| () (_ BitVec 32) (read32 memory11 |%3_@exp0|))
...
(define-fun |%19_@exp0| () (_ BitVec 32) (read32 memory11 |%retval_@exp0|))
;; store i32 %19, i32* %1
(define-fun memory12 () Mem (write32 memory11 |%1_@exp0| |%19_@exp0|))
;; br label %20
;; No backward arrows
...
;; %21 = load i32* %1
(define-fun |%21_@exp0| () (_ BitVec 32) (read32 memory12 |%1_@exp0|))
;; ret i32 %21
;; No backward arrows
...
;; store i32 %a, i32* %2, align 4
(define-fun memory14 () Mem (write32 memory13 |%2_@exp1| |%a_@exp1|))
;; store i32 %b, i32* %3, align 4
(define-fun memory15 () Mem (write32 memory14 |%3_@exp1| |%b_@exp1|))
;; store i32 1, i32* %retval, align 4
(define-fun memory16 () Mem (write32 memory15 |%retval_@exp1| (_ bv1 32)))
;; %4 = load i32* %3, align 4
(define-fun |%4_@exp1| () (_ BitVec 32) (read32 memory16 |%3_@exp1|))
;; %5 = icmp slt i32 %4, 0
...
;; store i32 0, i32* %1
(define-fun memory17 () Mem (write32 memory16 |%1_@exp1| (_ bv0 32)))
;; br label %28
;; No backward arrows
...
;; %8 = load i32* %3, align 4
(define-fun |%8_@exp1| () (_ BitVec 32) (read32 memory17 |%3_@exp1|))
;; %9 = icmp ne i32 %8, 0
...
(define-fun |%11_@exp1| () (_ BitVec 32) (read32 memory17 |%3_@exp1|))
;; %12 = and i32 %11, 1
...
(define-fun |%15_@exp1| () (_ BitVec 32) (read32 memory17 |%2_@exp1|))
;; %16 = load i32* %retval, align 4
(define-fun |%16_@exp1| () (_ BitVec 32) (read32 memory17 |%retval_@exp1|))
;; %17 = mul nsw i32 %16, %15
(define-fun |%17_@exp1| () (_ BitVec 32) (bvmul |%16_@exp1| |%15_@exp1|))
;; store i32 %17, i32* %retval, align 4
(define-fun memory18 () Mem (write32 memory17 |%retval_@exp1| |%17_@exp1|))
;; br label %18
;; No backward arrows
...
(define-fun |%19_@exp1| () (_ BitVec 32) (read32 memory18 |%3_@exp1|))
;; %20 = ashr i32 %19, 1
(define-fun |%20_@exp1| () (_ BitVec 32) (bvashr |%19_@exp1| (_ bv1 32)))
;; store i32 %20, i32* %3, align 4
(define-fun memory19 () Mem (write32 memory18 |%3_@exp1| |%20_@exp1|))
;; %21 = load i32* %2, align 4
(define-fun |%21_@exp1| () (_ BitVec 32) (read32 memory19 |%2_@exp1|))
;; %22 = load i32* %2, align 4
(define-fun |%22_@exp1| () (_ BitVec 32) (read32 memory19 |%2_@exp1|))
;; %23 = mul nsw i32 %22, %21
(define-fun |%23_@exp1| () (_ BitVec 32) (bvmul |%22_@exp1| |%21_@exp1|))
;; store i32 %23, i32* %2, align 4
(define-fun memory20 () Mem (write32 memory19 |%2_@exp1| |%23_@exp1|))
;; %24 = load i32* %3, align 4
(define-fun |%24_@exp1| () (_ BitVec 32) (read32 memory20 |%3_@exp1|))
;; %25 = icmp ne i32 %24, 0
...
(define-fun |%31_@exp1| () (_ BitVec 32) (read32 memory20 |%3_@exp1|))
;; %32 = and i32 %31, 1
...
(define-fun |%35_@exp1| () (_ BitVec 32) (read32 memory20 |%2_@exp1|))
;; %36 = load i32* %retval, align 4
(define-fun |%36_@exp1| () (_ BitVec 32) (read32 memory20 |%retval_@exp1|))
;; %37 = mul nsw i32 %36, %35
(define-fun |%37_@exp1| () (_ BitVec 32) (bvmul |%36_@exp1| |%35_@exp1|))
;; store i32 %37, i32* %retval, align 4
(define-fun memory21 () Mem (write32 memory20 |%retval_@exp1| |%37_@exp1|))
;; br label %38
;; No backward arrows
...
(define-fun |%39_@exp1| () (_ BitVec 32) (read32 memory21 |%3_@exp1|))
;; %40 = ashr i32 %39, 1
(define-fun |%40_@exp1| () (_ BitVec 32) (bvashr |%39_@exp1| (_ bv1 32)))
;; store i32 %40, i32* %3, align 4
(define-fun memory22 () Mem (write32 memory21 |%3_@exp1| |%40_@exp1|))
;; %41 = load i32* %2, align 4
(define-fun |%41_@exp1| () (_ BitVec 32) (read32 memory22 |%2_@exp1|))
;; %42 = load i32* %2, align 4
(define-fun |%42_@exp1| () (_ BitVec 32) (read32 memory22 |%2_@exp1|))
;; %43 = mul nsw i32 %42, %41
(define-fun |%43_@exp1| () (_ BitVec 32) (bvmul |%42_@exp1| |%41_@exp1|))
;; store i32 %43, i32* %2, align 4
(define-fun memory23 () Mem (write32 memory22 |%2_@exp1| |%43_@exp1|))
;; %44 = load i32* %3, align 4
(define-fun |%44_@exp1| () (_ BitVec 32) (read32 memory23 |%3_@exp1|))
;; %45 = icmp ne i32 %44, 0
...
(define-fun |%47_@exp1| () (_ BitVec 32) (read32 memory23 |%3_@exp1|))
;; %48 = and i32 %47, 1
...
(define-fun |%51_@exp1| () (_ BitVec 32) (read32 memory23 |%2_@exp1|))
;; %52 = load i32* %retval, align 4
(define-fun |%52_@exp1| () (_ BitVec 32) (read32 memory23 |%retval_@exp1|))
;; %53 = mul nsw i32 %52, %51
(define-fun |%53_@exp1| () (_ BitVec 32) (bvmul |%52_@exp1| |%51_@exp1|))
;; store i32 %53, i32* %retval, align 4
(define-fun memory24 () Mem (write32 memory23 |%retval_@exp1| |%53_@exp1|))
;; br label %54
;; No backward arrows
...
(define-fun |%55_@exp1| () (_ BitVec 32) (read32 memory24 |%3_@exp1|))
;; %56 = ashr i32 %55, 1
(define-fun |%56_@exp1| () (_ BitVec 32) (bvashr |%55_@exp1| (_ bv1 32)))
;; store i32 %56, i32* %3, align 4
(define-fun memory25 () Mem (write32 memory24 |%3_@exp1| |%56_@exp1|))
;; %57 = load i32* %2, align 4
(define-fun |%57_@exp1| () (_ BitVec 32) (read32 memory25 |%2_@exp1|))
;; %58 = load i32* %2, align 4
(define-fun |%58_@exp1| () (_ BitVec 32) (read32 memory25 |%2_@exp1|))
;; %59 = mul nsw i32 %58, %57
(define-fun |%59_@exp1| () (_ BitVec 32) (bvmul |%58_@exp1| |%57_@exp1|))
;; store i32 %59, i32* %2, align 4
(define-fun memory26 () Mem (write32 memory25 |%2_@exp1| |%59_@exp1|))
;; %60 = load i32* %3, align 4
(define-fun |%60_@exp1| () (_ BitVec 32) (read32 memory26 |%3_@exp1|))
;; %61 = icmp ne i32 %60, 0
...
(define-fun |%27_@exp1| () (_ BitVec 32) (read32 memory26 |%retval_@exp1|))
;; store i32 %27, i32* %1
(define-fun memory27 () Mem (write32 memory26 |%1_@exp1| |%27_@exp1|))
;; br label %28
;; No backward arrows
...
;; %29 = load i32* %1
(define-fun |%29_@exp1| () (_ BitVec 32) (read32 memory27 |%1_@exp1|))
;; ret i32 %29
;; No backward arrows
...
;; store i32 0, i32* %1
(define-fun memory29 () Mem (write32 memory28 |%1_@main| (_ bv0 32)))
;; store i32 %argc, i32* %2, align 4
(define-fun memory30 () Mem (write32 memory29 |%2_@main| |%argc_@main|))
;; store i8** %argv, i8*** %3, align 8
(define-fun memory31 () Mem (write64 memory30 |%3_@main| |%argv_@main|))
;; ret i32 0
;; No backward arrows
