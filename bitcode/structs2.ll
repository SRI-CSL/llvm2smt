...
entry:
  ...
  %7 = trunc i32 %5 to i8
  %bf.load = load i8, i8* %flip4, align 1
  %bf.value = and i8 %7, 1
  %bf.clear = and i8 %bf.load, -2
  %bf.set = or i8 %bf.clear, %bf.value
  store i8 %bf.set, i8* %flip4, align 1
  ...
  %bf.load6 = load i8, i8* %nybble5, align 1
  %bf.value7 = and i8 %10, 15
  %bf.shl = shl i8 %bf.value7, 1
  %bf.clear8 = and i8 %bf.load6, -31
  %bf.set9 = or i8 %bf.clear8, %bf.shl
  store i8 %bf.set9, i8* %nybble5, align 1
  %bf.result.shl10 = shl i8 %bf.value7, 4
  %bf.result.ashr11 = ashr i8 %bf.result.shl10, 4
  %bf.result.cast12 = sext i8 %bf.result.ashr11 to i32
  %11 = load i32, i32* %septet.addr, align 4
  %12 = load %struct.foo5*, %struct.foo5** %retval1, align 8
  %septet13 = getelementptr inbounds %struct.foo5, %struct.foo5* %12, i32 0, i32 3
  %13 = trunc i32 %11 to i8
  %bf.load14 = load i8, i8* %septet13, align 4
  %bf.value15 = and i8 %13, 127
  %bf.clear16 = and i8 %bf.load14, -128
  %bf.set17 = or i8 %bf.clear16, %bf.value15
  store i8 %bf.set17, i8* %septet13, align 4
  %bf.result.shl18 = shl i8 %bf.value15, 1
  %bf.result.ashr19 = ashr i8 %bf.result.shl18, 1
  %bf.result.cast20 = sext i8 %bf.result.ashr19 to i32
...
entry:
  ...
  store i64 %bf.set, i64* %3, align 4
  ...
  %bf.load9 = load i64, i64* %11, align 4
  ...
  store i64 %bf.set13, i64* %11, align 4
  ...
  %bf.load17 = load i64, i64* %15, align 4
  ...
  store i64 %bf.set21, i64* %15, align 4
...
entry:
  ...
  %3 = bitcast %struct.foo8* %2 to i32*
  %bf.load = load i32, i32* %3, align 4
  %bf.value = and i32 %1, 2147483647
  %bf.clear = and i32 %bf.load, -2147483648
  %bf.set = or i32 %bf.clear, %bf.value
  ...
  %bf.result.shl = shl i32 %bf.value, 1
  %bf.result.ashr = ashr i32 %bf.result.shl, 1
  %4 = load i32, i32* %bigfield2.addr, align 4
  %5 = load %struct.foo8*, %struct.foo8** %retval1, align 8
  %bigfield22 = getelementptr inbounds %struct.foo8, %struct.foo8* %5, i32 0, i32 1
  %6 = bitcast i40* %bigfield22 to i64*
  %7 = zext i32 %4 to i64
  %bf.load3 = load i64, i64* %6, align 4
  %bf.value4 = and i64 %7, 2147483647
  %bf.clear5 = and i64 %bf.load3, -2147483648
  %bf.set6 = or i64 %bf.clear5, %bf.value4
  store i64 %bf.set6, i64* %6, align 4
  %bf.result.shl7 = shl i64 %bf.value4, 33
  %bf.result.ashr8 = ashr i64 %bf.result.shl7, 33
  %bf.result.cast = trunc i64 %bf.result.ashr8 to i32
  %8 = load i32, i32* %littlefield1.addr, align 4
  %9 = load %struct.foo8*, %struct.foo8** %retval1, align 8
  %littlefield19 = getelementptr inbounds %struct.foo8, %struct.foo8* %9, i32 0, i32 1
  %10 = bitcast i40* %littlefield19 to i64*
  %11 = zext i32 %8 to i64
  %bf.load10 = load i64, i64* %10, align 4
  %bf.value11 = and i64 %11, 1
  %bf.shl = shl i64 %bf.value11, 31
  %bf.clear12 = and i64 %bf.load10, -2147483649
  %bf.set13 = or i64 %bf.clear12, %bf.shl
  store i64 %bf.set13, i64* %10, align 4
  %bf.result.shl14 = shl i64 %bf.value11, 63
  %bf.result.ashr15 = ashr i64 %bf.result.shl14, 63
  %bf.result.cast16 = trunc i64 %bf.result.ashr15 to i32
  %12 = load i32, i32* %littlefield2.addr, align 4
  %13 = load %struct.foo8*, %struct.foo8** %retval1, align 8
  %littlefield217 = getelementptr inbounds %struct.foo8, %struct.foo8* %13, i32 0, i32 1
  %14 = bitcast i40* %littlefield217 to i64*
  %15 = zext i32 %12 to i64
  %bf.load18 = load i64, i64* %14, align 4
  %bf.value19 = and i64 %15, 1
  %bf.shl20 = shl i64 %bf.value19, 32
  %bf.clear21 = and i64 %bf.load18, -4294967297
  %bf.set22 = or i64 %bf.clear21, %bf.shl20
  store i64 %bf.set22, i64* %14, align 4
  %bf.result.shl23 = shl i64 %bf.value19, 63
  %bf.result.ashr24 = ashr i64 %bf.result.shl23, 63
  %bf.result.cast25 = trunc i64 %bf.result.ashr24 to i32
  %16 = load %struct.foo8*, %struct.foo8** %retval1, align 8
  ret %struct.foo8* %16
}
...
entry:
  ...
  store %struct.foo11* %1, %struct.foo11** %p2, align 8
...
entry:
  ...
  %call = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %0, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32 24, i32 0)
  %1 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call1 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %1, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32 24, i32 8)
  %2 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call2 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %2, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32 24, i32 16)
  ...
  %call6 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %6, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i32 0, i32 0), i32 16, i32 8)
  %7 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call7 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %7, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i32 0, i32 0), i32 16, i32 0)
  %8 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call8 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %8, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i32 0, i32 0), i32 4, i32 0)
  %9 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call9 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %9, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i32 0, i32 0), i32 4, i32 2)
  %10 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call10 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %10, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.10, i32 0, i32 0), i32 8, i32 0)
  %11 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call11 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %11, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.10, i32 0, i32 0), i32 8, i32 2)
  %12 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call12 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %12, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i32 0, i32 0), i32 24, i32 0)
  %13 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call13 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %13, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.12, i32 0, i32 0), i32 24, i32 0)
  %14 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call14 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %14, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.12, i32 0, i32 0), i32 24, i32 8)
  %15 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call15 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %15, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.13, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.12, i32 0, i32 0), i32 24, i32 16)
  %16 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call16 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %16, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.14, i32 0, i32 0), i32 16, i32 10)
  %17 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %call17 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %17, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.15, i32 0, i32 0), i32 24, i32 16)
  ret i32 0
}
